  ...
  return (
    <button
      className={cn(
        ...
        props.dateHover ? props.dateHover : "hover:bg-gray-200",
        // Today styling - blue indicator when not selected and not disabled
        isTodayDate && !isActive && !isDisabled && todayStyle
          ? todayStyle
          : isTodayDate && !isActive && !isDisabled
          ? "bg-blue-50 text-blue-600 font-semibold"
          : "",
        // Active/selected styling
        isActive && !isDisabled && selected
          ? selected
          : isActive && !isDisabled
        ...
        isDisabled &&
          !isActive &&
          "opacity-50 bg-gray-50 cursor-not-allowed hover:bg-gray-50",
        isDisabled &&
          isActive &&
          "bg-gray-700 text-white opacity-70 cursor-not-allowed",
        className
      )}
