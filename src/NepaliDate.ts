...
export class NepaliDate {
    ...
    private _month: number; // 0-based like JavaScript Date
    ...
    private normalize(): void {
        ...
        while (this._date < 1) {
            ...
            const prevMonthDays = BS_MONTHS[this._year as BS_MONTHS_KEYS][this._month];
        ...
        while (this._date > monthDays) {
            ...
            const currentMonthDays = BS_MONTHS[this._year as BS_MONTHS_KEYS][this._month];
