        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-gray-100 p-8">
            <div className="max-w-7xl mx-auto space-y-12">
                ...
                <div className="text-center">
                    <h1 className="text-4xl font-bold text-white mb-4">Date-NP Package Demo</h1>
                    <p className="text-lg text-gray-400">Comprehensive Nepali and English date formatting and calendar picking library</p>
                </div>

                {/* Info Card */}
                <div className="bg-gradient-to-r from-gray-800 to-gray-700 border border-gray-600 rounded-xl p-6 max-w-2xl mx-auto">
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            <h4 className="text-sm font-semibold text-green-400 mb-1">Sample Dates Used</h4>
                ...
                <div className="text-start">
                    <h1 className="text-2xl font-bold text-white mb-4">Calendar Date Pickers</h1>
                    <p className="text-lg text-gray-400">Robust date pickers for picking single/range, converting BS/AD dates seamlessly</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* Single Date Picker */}
                    <div className="bg-gray-800 rounded-xl shadow-lg p-6 max-w-md mx-auto w-full">
                        <div className="text-center mb-6">
                            <h3 className="text-xl font-bold text-white mb-2">Single Date Picker</h3>
                            <p className="text-gray-400 text-sm">Select a single date</p>
                        </div>
                        <Picker
                    ...
                    <div className="bg-gray-800 rounded-xl shadow-lg p-6 max-w-md mx-auto w-full">
                        <div className="text-center mb-6">
                            <h3 className="text-xl font-bold text-white mb-2">Range Date Picker</h3>
                            <p className="text-gray-400 text-sm">Select a date range</p>
                        </div>
                        <RangePicker
                            minDate={new Date(2025, 9, 10)}
                            maxDate={new Date(2025, 11, 20)}
                            shouldShowInput={true}
                            label="Select the overlap period"
                ...
                <div className="text-start">
                    <h1 className="text-2xl font-bold text-white mb-4">Format Function</h1>
                    <p className="text-lg text-gray-400">Complete date string formatting made to specially work with both Bikram Sambat and Gregorian calendar</p>
                </div>
                <div className="bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                    <div className="bg-gradient-to-r from-gray-700 to-gray-600 px-6 py-4">
                        ...
                        <p className="text-gray-400 mt-1">Comparing Nepali (BS) and English (AD) date formats</p>
                    </div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            <thead className="bg-gray-700 border-b border-gray-600">
                                <tr>
                                    <th className="px-6 py-4 text-left text-sm font-semibold text-gray-300">Format Type</th>
                                    <th className="px-6 py-4 text-left text-sm font-semibold text-gray-400">Token</th>
                                    <th className="px-6 py-4 text-left text-sm font-semibold text-indigo-400">Nepali</th>
                                    <th className="px-6 py-4 text-left text-sm font-semibold text-blue-400">English</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-gray-700">
                                {formatExamples.map((example, index) => (
                                    <tr key={index} className="hover:bg-gray-700 transition-colors duration-150">
                                        ...
                                        <td className="px-6 py-4 text-sm text-gray-400 font-mono bg-gray-800">
                                            {example.code}
                                        </td>
                                        <td className="px-6 py-4 text-sm text-indigo-400 font-mono bg-gray-900">
                                            {example.nepali}
                                        </td>
                                        <td className="px-6 py-4 text-sm text-blue-400 font-mono bg-gray-900">
                                            {example.english}
                                        </td>
                                    </tr>
                                ))}
